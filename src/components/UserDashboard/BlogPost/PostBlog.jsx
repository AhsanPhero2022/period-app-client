  ...
  return (
    <div className="py-8 px-5 h-full"> 
      <div className="bg-white border  border-slate-200 grid grid-cols-6  gap-2 rounded-xl p-2 text-sm">
        <h1 className="text-center text-slate-500 text-xl font-bold col-span-6 py-4">
          What's your mind
        </h1>
        <textarea
          placeholder="Post a blog..."
          className="bg-slate-100 h-96 text-slate-600  placeholder:text-slate-600 placeholder:opacity-50 border border-slate-200 col-span-6 resize-none outline-none rounded-lg p-2 duration-300 focus:border-slate-600"
        ></textarea>
